...
elif package_version is not None and package_version.startswith('0.8.'):
    vllm_version = '0.8.5'
    from .vllm_v_0_8_5.llm import LLM
    from .vllm_v_0_8_5.llm import LLMEngine
    from .vllm_v_0_8_5 import parallel_state
else:
    raise ValueError(
        f'vllm version {package_version} not supported. Currently supported versions are 0.3.1, 0.4.2, 0.5.4, 0.6.3 and 0.8.x.'
    )
