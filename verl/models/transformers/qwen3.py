...
"""
Qwen3 Flash Attention forward implementation with Ulysses sequence parallel support.
Adapted from qwen2.py - Qwen3 uses the same attention mechanism as Qwen2.
"""
...
def qwen3_flash_attn_forward(
    ...
    # Qwen3 uses q_norm and k_norm (QK-Norm) if available
